...
const PALETTE = {
    ...
    2: [255, 255, 255, 255],       // white belly / face
    3: [220, 110, 0, 255],         // orange feet
    4: [175, 185, 200, 255],       // light gray (belly shadow)
    5: [255, 210, 0, 255],         // gold beak highlight
    6: [215, 40, 40, 255],         // red (alarm / bomb)
    7: [0, 220, 80, 255],          // green exit
    8: [20, 20, 45, 255],          // dark navy (puffin back / wings)
    9: [230, 85, 15, 255]          // vivid orange-red beak
};
